/**
 *  Copyright 2018 Robert Vandervoort and 2016 Eric Maycock
 *
 ...
 *
 *  Original WallMote Author: Eric Maycock (erocm123)
 *  Date: 2016-12-2
 *	Modified for use on NanoMote products 2018-5-2
 */
 
metadata {
	definition (name: "Aeon NanoMote", namespace: "robertvandervoort", author: "Robert Vandervoort") {
	capability "Actuator"
	capability "Button"
...
// for the one zw:Ss type:1801 mfr:0371 prod:0102 model:0004 ver:1.00 zwv:4.61 lib:03 cc:5E,55,98,9F sec:86,85,59,72,5A,73,80,84,5B,70,6C,7A secOut:26 role:04 ff:9600 ui:9600
        fingerprint mfr: "0371", prod: "0102", model: "0004"
// fir the quad zw:S type:1801 mfr:0371 prod:0102 model:0003 ver:1.00 zwv:4.61 lib:03 cc:5E,85,59,55,86,72,5A,73,80,98,9F,84,5B,70,6C,7A ccOut:26 role:04 ff:9600 ui:9600
        fingerprint mfr: "0371", prod: "0102", model: "0003"
...
'''
<configuration>
  <Value type="list" byteSize="1" index="buttons" label="NanoMote Model" min="1" max="4" value="" setting_type="preference" fw="" displayDuringSetup="true">
    <Help>
